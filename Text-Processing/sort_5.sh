...
#
#Task
#You are given a file of text,which contains temperature information about American cities, in TSV (tab-separated) format. The first c
#
#Input Format
#A text file where each line contains a row of data as described above.
#
#Output Format
#Rearrange the rows of the table in descending order of the values for the average temperature in January (i.e, the mean temperature v
#
#Sample Input
#
