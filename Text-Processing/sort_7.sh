...
#In linux, the most vanilla version of 'sort' simply rearranges the lines in a file, in lexicographical order. Using a variety of flag
...
#Task
#
#You are given a file of pipe-delimited weather data (TSV). There is no header column in this data file. The first five columns of thi
#
